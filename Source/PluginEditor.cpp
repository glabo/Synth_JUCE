...
Synth_JUCEAudioProcessorEditor::Synth_JUCEAudioProcessorEditor(Synth_JUCEAudioProcessor& p)
    ...
    oscillatorComponent0(p, OSC_0, WAVETYPE_ID_0, GAIN_ID_0, COARSE_PITCH_ID_0, DELAY_ID_0, ATTACK_ID_0, DECAY_ID_0, SUSTAIN_ID_0, RELEASE_ID_0),
    oscillatorComponent1(p, OSC_1, WAVETYPE_ID_1, GAIN_ID_1, COARSE_PITCH_ID_1, DELAY_ID_1, ATTACK_ID_1, DECAY_ID_1, SUSTAIN_ID_1, RELEASE_ID_1),
    oscillatorComponent2(p, OSC_2, WAVETYPE_ID_2, GAIN_ID_2, COARSE_PITCH_ID_2, DELAY_ID_2, ATTACK_ID_2, DECAY_ID_2, SUSTAIN_ID_2, RELEASE_ID_2),
    oscillatorComponent3(p, OSC_3, WAVETYPE_ID_3, GAIN_ID_3, COARSE_PITCH_ID_3, DELAY_ID_3, ATTACK_ID_3, DECAY_ID_3, SUSTAIN_ID_3, RELEASE_ID_3),
    filterComponent(p, FILTER_TYPE_ID, CUTOFF_FREQ_ID, Q_ID, RESONANCE_ID, FILTER_ADSR_AMOUNT_ID, FILTER_ATTACK_ID, FILTER_DECAY_ID, FILTER_SUSTAIN_ID, FILTER_RELEASE_ID)
{
